  ...
  return (
    <div className='contact'>
      <div className="contact-col">
        ...
        <p>Feel freee to reach out to us through the contact form or finf the contact information below.</p>
        <ul>
            <li><img src={mailicon} alt="" /> Contact@AS.com</li>
            <li><img src={phicon} alt="" /> +91 123 456 7890</li>
            <li><img src={locicon} alt="" /> Sourav Vihar Nagar, Burla, Sambalpur</li>
        </ul>
      </div>
<div className="contact-col">
